...
const generateMockUsers = () => {
    const users = {
        sarahwang: {
            ...
            photos: samplePhotos.filter(
                (photo) => photo.username === "sarahwang"
            ),
        },
        estebancd: {
            username: "estebancd",
            ...
            photos: samplePhotos.filter(
                (photo) => photo.username === "estebancd"
            ),
        },
        emmajarnie: {
            username: "emmajarnie",
            ...
            photos: samplePhotos.filter(
                (photo) => photo.username === "emmajarnie"
            ),
        },
        kaylaluo: {
            username: "kaylaluo",
        ...
        <Container maxWidth='md' sx={{ textAlign: "center", mt: 10 }}>
            ...
            <Avatar
                ...
                onError={(e) => {
                    ...
                    const gender =
                        username.includes("esteban") ? "male" : "female";
            ...
            >
                ...
                {userData.photos.reduce((acc, p) => acc + (p.likes || 0), 0)}{" "}
                LIKES
            </Typography>
